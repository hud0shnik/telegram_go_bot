...
Просто мой телеграм бот. Просто на golang. Функционал постоянно обновляется, так что лучше спросить о нём у самого бота. Из API: уже реализовал погоду, фото дня
от Nasa, картинки с Reddit'a (попугаи, кошечки и просто смешные картинки) и текущий курс трёх криптовалют (SHIB, BTC и ETH). 
