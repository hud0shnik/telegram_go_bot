...
Просто мой телеграм бот. Просто на golang. Весь функционал он сам тебе расскажет. Переодически добавляю новые функции. Из API: уже реализовал погоду и фото дня
от Nasa. 
